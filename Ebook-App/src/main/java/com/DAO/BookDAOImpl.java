...
////		boolean f = false;
////		try {
////			String sql = "insert into book_dtls(bookname,author,price,bookCategory,status,photo,email,isbn,genre) values(?,?,?,?,?,?,?,?,?)";
...
////		boolean f = false;
////		try {
////			String sql = "update book_dtls set bookname=?,author=?,price=?,bookCategory=?,status=?,isbn=?,genre=? where bookId=?";
////			PreparedStatement ps = conn.prepareStatement(sql);
////			ps.setString(1, b.getBookName());
////			ps.setString(2, b.getAuthor());
////			ps.setString(3, b.getPrice());
...
//
//		try {
//			String sql = "select * from tbl_book_dtls";
//			PreparedStatement ps = conn.prepareStatement(sql);
//
//			ResultSet rs = ps.executeQuery();
//			while (rs.next()) {
...
//		BookDtls b = null;
//		try {
//			String sql = "select * from tbl_book_dtls where book_bookId=?";
//			PreparedStatement ps = conn.prepareStatement(sql);
//			ps.setInt(1, id);
//
//			ResultSet rs = ps.executeQuery();
...
//		boolean f = false;
//		try {
//			String sql = "update tbl_book_dtls set book_bookname=?,book_author=?,book_price=?,book_bookCategory=?,book_status=?,book_isbn=?,book_genre=? where book_bookId=?";
//			PreparedStatement ps = conn.prepareStatement(sql);
//			ps.setString(1, b.getBookName());
//			ps.setString(2, b.getAuthor());
//			ps.setString(3, b.getPrice());
