...
<body>
	...
	<div class="wrapper">
		<h4 class="text-uppercase text-center">Card Details</h4>
		<form class="form mt-4" id="cardform" novalidate
				...
				<div class="d-flex w-50 pl-sm-5 pl-3">
					<div class="form-group">
						<label for="cvv">CVV</label> <a href="#"
							title="CVV is a credit or debit card number, the last three digit number printed on the signature panel">   Help!
							</a> <input name="cvv" type="password" class="form-control pr-5">
					</div>
				</div>
			</div>

			<div class="form-group">
				<label for="name" class="text-uppercase">name as on card</label> <input
			...
			%>
			<div class="form-group">
				<label for="name" class="text-uppercase">Order Amount</label> <input
